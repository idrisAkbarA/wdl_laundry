                ...
                <div class="mx-5">
                    ...
                    <v-row rows="12" sm="6" md="3">
                        <v-col cols="12" lg="3" sm="6" md="3">
                            <v-text-field name="nama" label="Nama Loket" prepend-inner-icon="store" filled>
                            </v-text-field>
                        </v-col>
                        <v-col cols="12" lg="3" sm="6" md="3">
                        ...
                        <v-col cols="12" lg="3" sm="6" md="3">
                            <v-text-field type="tel" name="hp" label="Nomor HP" prepend-inner-icon="phone" filled>
                            </v-text-field>
                        </v-col>
                        <v-col cols="12" lg="3" sm="6" md="3">
                            <v-text-field name="email" label="Email" prepend-inner-icon="email" type="email" filled>
                            </v-text-field>
                        </v-col>
                    </v-row>
