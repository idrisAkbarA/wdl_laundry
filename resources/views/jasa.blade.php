            ...
            <div class="mx-5">
                <v-row rows="12" sm="6" md="3">
                    <v-col cols="12" lg="4" sm="6" md="3">
                        <v-text-field label="Jasa" prepend-inner-icon="local_laundry_service" filled></v-text-field>
                    </v-col>
                    <v-col cols="12" lg="4" sm="6" md="3">
                        <v-text-field label="Satuan" prepend-inner-icon="layers" filled></v-text-field>
                    </v-col>
                    <v-col cols="12" lg="4" sm="6" md="3">
                        <v-text-field label="Harga Satuan" prepend-inner-icon="attach_money" filled></v-text-field>
                    </v-col>
                </v-row>
            </div>
            <div class="pl-4">
