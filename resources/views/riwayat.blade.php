                        ...
                        <v-row>
                            ...
                            <v-col cols="12" lg="3" sm="4" md="3">
                                ...
                                <v-dialog ref="dialog" v-model="modal" :return-value.sync="date" persistent
                                    width="290px">
                                    <template v-slot:activator="{ on }">
                                        <v-text-field v-model="date1" label="Dari" prepend-inner-icon="search" readonly
                                            filled v-on="on"></v-text-field>
                                    </template>
                            ...
                            <v-col cols="12" lg="3" sm="4" md="3">
                                ...
                                <v-dialog ref="dialog" v-model="modal" :return-value.sync="date" persistent
                                    width="290px">
                                    <template v-slot:activator="{ on }">
                                        <v-text-field v-model="date2" label="Sampai" prepend-inner-icon="search" readonly
                                            filled v-on="on"></v-text-field>
                                    </template>
